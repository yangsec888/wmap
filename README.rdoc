...
To install the above gems, use the command below:

      $ gem install dnsruby geoip minitest net-ping netaddr:1.5.1 nokogiri css_parser open_uri_redirections openssl parallel whois httpclient
